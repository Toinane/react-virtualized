...
var Grid = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Grid(props /*: Props*/) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_setScrollingContainerRef", function (ref /*: Element*/) {
      _this._scrollingContainer = ref;
    });
    _defineProperty(_assertThisInitialized(_this), "_onScroll", function (event /*: Event*/) {
