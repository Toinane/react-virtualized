!function(global, factory) {
    "object" == typeof exports && "undefined" != typeof module ? factory(exports, require("react"), require("react-dom")) : "function" == typeof define && define.amd ? define([ "exports", "react", "react-dom" ], factory) : factory((global = "undefined" != typeof globalThis ? globalThis : global || self).ReactVirtualized = {}, global.React, global.ReactDOM);
    ...
    var React__namespace = /* */ _interopNamespaceDefault(React), ReactDOM__namespace = /* */ _interopNamespaceDefault(ReactDOM);
   ...
   */    function componentWillMount() {
    ...
    var ArrowKeyStepper = function() {
        _inherits(ArrowKeyStepper, React__namespace.PureComponent);
    ...
    var AutoSizer = function() {
        _inherits(AutoSizer, React__namespace.Component);
        ...
        return _createClass(AutoSizer, [ {
            ...
            value: function() {
                ...
                childParams.width = width), React__namespace.createElement("div", {
                    className: className,
                    ref: this._setRef,
    ...
    var CellMeasurer = function() {
        _inherits(CellMeasurer, React__namespace.PureComponent);
 ...
 // AsyncMode is deprecated along with isAsyncMode
        ...
        var hasSymbol, REACT_ELEMENT_TYPE, REACT_PORTAL_TYPE, REACT_FRAGMENT_TYPE, REACT_STRICT_MODE_TYPE, REACT_PROFILER_TYPE, REACT_PROVIDER_TYPE, REACT_CONTEXT_TYPE, REACT_ASYNC_MODE_TYPE, REACT_CONCURRENT_MODE_TYPE, REACT_FORWARD_REF_TYPE, REACT_SUSPENSE_TYPE, REACT_SUSPENSE_LIST_TYPE, REACT_MEMO_TYPE, REACT_LAZY_TYPE, REACT_BLOCK_TYPE, REACT_FUNDAMENTAL_TYPE, REACT_RESPONDER_TYPE, REACT_SCOPE_TYPE, AsyncMode, ConcurrentMode, ContextConsumer, ContextProvider, Element, ForwardRef, Fragment, Lazy, Memo, Portal, Profiler, StrictMode, Suspense, hasWarnedAboutDeprecatedIsAsyncMode;
        ...
        REACT_STRICT_MODE_TYPE = hasSymbol ? Symbol.for("react.strict_mode") : 60108, REACT_PROFILER_TYPE = hasSymbol ? Symbol.for("react.profiler") : 60114, 
        REACT_PROVIDER_TYPE = hasSymbol ? Symbol.for("react.provider") : 60109, REACT_CONTEXT_TYPE = hasSymbol ? Symbol.for("react.context") : 60110, 
        REACT_ASYNC_MODE_TYPE = hasSymbol ? Symbol.for("react.async_mode") : 60111, REACT_CONCURRENT_MODE_TYPE = hasSymbol ? Symbol.for("react.concurrent_mode") : 60111, 
        REACT_FORWARD_REF_TYPE = hasSymbol ? Symbol.for("react.forward_ref") : 60112, REACT_SUSPENSE_TYPE = hasSymbol ? Symbol.for("react.suspense") : 60113, 
        ...
        REACT_RESPONDER_TYPE = hasSymbol ? Symbol.for("react.responder") : 60118, REACT_SCOPE_TYPE = hasSymbol ? Symbol.for("react.scope") : 60119, 
        AsyncMode = REACT_ASYNC_MODE_TYPE, ConcurrentMode = REACT_CONCURRENT_MODE_TYPE, 
        ContextConsumer = REACT_CONTEXT_TYPE, ContextProvider = REACT_PROVIDER_TYPE, Element = REACT_ELEMENT_TYPE, 
        ForwardRef = REACT_FORWARD_REF_TYPE, Fragment = REACT_FRAGMENT_TYPE, Lazy = REACT_LAZY_TYPE, 
        Memo = REACT_MEMO_TYPE, Portal = REACT_PORTAL_TYPE, Profiler = REACT_PROFILER_TYPE, 
        StrictMode = REACT_STRICT_MODE_TYPE, Suspense = REACT_SUSPENSE_TYPE, hasWarnedAboutDeprecatedIsAsyncMode = !1, 
    ...
    reactIs_development.AsyncMode, reactIs_development.ConcurrentMode, reactIs_development.ContextConsumer, 
    reactIs_development.ContextProvider, reactIs_development.Element, reactIs_development.ForwardRef, 
    reactIs_development.Fragment, reactIs_development.Lazy, reactIs_development.Memo, 
    reactIs_development.Portal, reactIs_development.Profiler, reactIs_development.StrictMode, 
    reactIs_development.Suspense, reactIs_development.isAsyncMode, reactIs_development.isConcurrentMode, 
    reactIs_development.isContextConsumer, reactIs_development.isContextProvider, reactIs_development.isElement, 
    reactIs_development.isForwardRef, reactIs_development.isFragment, reactIs_development.isLazy, 
    reactIs_development.isMemo, reactIs_development.isPortal, reactIs_development.isProfiler, 
    reactIs_development.isStrictMode, reactIs_development.isSuspense, reactIs_development.isValidElementType, 
  ...
  @license MIT
  */
    /* eslint-disable no-unused-vars */    var printWarning$1, objectAssign = function() {
        try {
 ...
 // eslint-disable-line no-new-wrappers
        ...
        return to;
    }, ReactPropTypesSecret_1 = "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED", has$1 = Function.call.bind(Object.prototype.hasOwnProperty), loggedTypeFailures = {}, has = has$1;
    /**
   * Copyright (c) 2013-present, Facebook, Inc.
   *
   * This source code is licensed under the MIT license found in the
    ...
    function checkPropTypes(typeSpecs, values, location, componentName, getStack) {
        for (var typeSpecName in typeSpecs) if (has(typeSpecs, typeSpecName)) {
            ...
            error instanceof Error && !(error.message in loggedTypeFailures)) {
                ...
                printWarning$1("Failed " + location + " type: " + error.message + (null != stack ? stack : ""));
            }
        }
    }
    /**
   ...
   */    printWarning$1 = function(text) {
    ...
    var printWarning, checkPropTypes_1 = checkPropTypes;
    ...
    function factoryWithTypeCheckers(isValidElement, throwOnDirectAccess) {
        ...
        var ITERATOR_SYMBOL = "function" == typeof Symbol && Symbol.iterator, FAUX_ITERATOR_SYMBOL = "@@iterator", ANONYMOUS = "<<anonymous>>", ReactPropTypes = {
            ...
            oneOf: function(expectedValues) {
                if (!Array.isArray(expectedValues)) return printWarning(1 < arguments.length ? "Invalid arguments supplied to oneOf, expected an array, got " + arguments.length + " arguments. A common mistake is to write oneOf(x, y, z) instead of oneOf([x, y, z])." : "Invalid argument supplied to oneOf, expected an array."), 
            ...
            oneOfType: function(arrayOfTypeCheckers) {
                ...
                return createChainableTypeChecker(function(props, propName, componentName, location, propFullName) {
                    for (var expectedTypes = [], i = 0; i < arrayOfTypeCheckers.length; i++) {
                        ...
                        checkerResult.data && has$1(checkerResult.data, "expectedType") && expectedTypes.push(checkerResult.data.expectedType);
                    }
            ...
            exact: function(shapeTypes) {
                return createChainableTypeChecker(function(props, propName, componentName, location, propFullName) {
                    ...
                    for (var key in allKeys) {
                        var checker = shapeTypes[key];
                        if (has$1(shapeTypes, key) && "function" != typeof checker) return invalidValidatorError(componentName, location, propFullName, key, getPreciseType(checker));
    ...
    var SCROLL_POSITION_CHANGE_REASONS$1_OBSERVED = "observed", SCROLL_POSITION_CHANGE_REASONS$1_REQUESTED = "requested", CollectionView = function() {
        _inherits(CollectionView, React__namespace.PureComponent);
            ...
            _defineProperty(_assertThisInitialized(_this), "_invokeOnSectionRenderedHelper", function() {
                ...
                if (event.target === _this._scrollingContainer) {
                    ...
                    if (_this.state.scrollLeft !== scrollLeft || _this.state.scrollTop !== scrollTop) {
                        var scrollPositionChangeReason = event.cancelable ? SCROLL_POSITION_CHANGE_REASONS$1_OBSERVED : SCROLL_POSITION_CHANGE_REASONS$1_REQUESTED;
        ...
        return _createClass(CollectionView, [ {
            ...
            value: function(prevProps, prevState) {
                ...
                scrollPositionChangeReason === SCROLL_POSITION_CHANGE_REASONS$1_REQUESTED && (0 <= scrollLeft && scrollLeft !== prevState.scrollLeft && scrollLeft !== this._scrollingContainer.scrollLeft && (this._scrollingContainer.scrollLeft = scrollLeft), 
            ...
            value: function() {
                ...
                React__namespace.createElement("div", {
                    ...
                    tabIndex: 0
                }, 0 < cellCount && React__namespace.createElement("div", {
    ...
    var Collection = function() {
        _inherits(Collection, React__namespace.PureComponent);
        ...
        return _createClass(Collection, [ {
            ...
            value: function() {
                ...
                return React__namespace.createElement(CollectionView, _extends({
    ...
    var ColumnSizer = function() {
        _inherits(ColumnSizer, React__namespace.PureComponent);
    ...
    }, _excluded$1 = [ "maxScrollSize" ], ScalingCellSizeAndPositionManager = function() {
        function ScalingCellSizeAndPositionManager(_ref) {
            var _ref$maxScrollSize = _ref.maxScrollSize, maxScrollSize = void 0 === _ref$maxScrollSize ? getMaxElementSize() : _ref$maxScrollSize, params = _objectWithoutProperties(_ref, _excluded$1);
    ...
    function defaultCellRangeRenderer(_ref) {
        for (var cellCache = _ref.cellCache, cellRenderer = _ref.cellRenderer, columnSizeAndPositionManager = _ref.columnSizeAndPositionManager, columnStartIndex = _ref.columnStartIndex, columnStopIndex = _ref.columnStopIndex, deferredMeasurementCache = _ref.deferredMeasurementCache, horizontalOffsetAdjustment = _ref.horizontalOffsetAdjustment, isScrolling = _ref.isScrolling, isScrollingOptOut = _ref.isScrollingOptOut, parent = _ref.parent, rowSizeAndPositionManager = _ref.rowSizeAndPositionManager, rowStartIndex = _ref.rowStartIndex, rowStopIndex = _ref.rowStopIndex, styleCache = _ref.styleCache, verticalOffsetAdjustment = _ref.verticalOffsetAdjustment, visibleColumnIndices = _ref.visibleColumnIndices, visibleRowIndices = _ref.visibleRowIndices, renderedCells = [], areOffsetsAdjusted = columnSizeAndPositionManager.areOffsetsAdjusted() || rowSizeAndPositionManager.areOffsetsAdjusted(), canCacheStyle = !isScrolling && !areOffsetsAdjusted, rowIndex = rowStartIndex; rowIndex <= rowStopIndex; rowIndex++) for (var rowDatum = rowSizeAndPositionManager.getSizeAndPositionOfCell(rowIndex), columnIndex = columnStartIndex; columnIndex <= columnStopIndex; columnIndex++) {
            ...
            renderedCell.props.role || (renderedCell = React.cloneElement(renderedCell, {
                role: "gridcell"
    ...
    var request = (win = "undefined" != typeof window ? window : "undefined" != typeof self ? self : {}).requestAnimationFrame || win.webkitRequestAnimationFrame || win.mozRequestAnimationFrame || win.oRequestAnimationFrame || win.msRequestAnimationFrame || function(callback) {
        ...
        return frame;
    }, SCROLL_POSITION_CHANGE_REASONS_OBSERVED = "observed", SCROLL_POSITION_CHANGE_REASONS_REQUESTED = "requested", Grid = function() {
        _inherits(Grid, React__namespace.PureComponent);
        ...
        return _createClass(Grid, [ {
            ...
            value: function(prevProps, prevState) {
                ...
                scrollPositionChangeReason === SCROLL_POSITION_CHANGE_REASONS_REQUESTED && (!autoWidth && 0 <= scrollLeft && (scrollLeft !== this._scrollingContainer.scrollLeft || columnOrRowCountJustIncreasedFromZero) && (this._scrollingContainer.scrollLeft = scrollLeft), 
            ...
            value: function() {
                ...
                return React__namespace.createElement("div", _extends({
                    ...
                    tabIndex: tabIndex
                }), 0 < childrenToDisplay.length && React__namespace.createElement("div", {
    ...
    var InfiniteLoader = function() {
        _inherits(InfiniteLoader, React__namespace.PureComponent);
    ...
    var List = function() {
        _inherits(List, React__namespace.PureComponent);
        ...
        return _createClass(List, [ {
            ...
            key: "render",
            value: function() {
                var _this$props = this.props, className = _this$props.className, noRowsRenderer = _this$props.noRowsRenderer, scrollToIndex = _this$props.scrollToIndex, width = _this$props.width, containerStyle = _this$props.containerStyle, classNames = clsx("ReactVirtualized__List", className);
                return React__namespace.createElement(Grid, _extends({}, this.props, {
    ...
    var PositionCache = function() {
        ...
        _inherits(Masonry, React__namespace.PureComponent);
        ...
        return _createClass(Masonry, [ {
            ...
            value: function() {
                ...
                return this._startIndex = startIndex, this._stopIndex = stopIndex, React__namespace.createElement("div", {
                    ref: this._setScrollingContainerRef,
                    "aria-label": this.props["aria-label"],
    ...
    var CellMeasurerCacheDecorator = function() {
    ...
    }(), _excluded = [ "rowIndex" ], _excluded2 = [ "columnIndex", "rowIndex" ], _excluded3 = [ "columnIndex" ], _excluded4 = [ "onScroll", "onSectionRendered", "onScrollbarPresenceChange", "scrollLeft", "scrollToColumn", "scrollTop", "scrollToRow" ], MultiGrid = function() {
        _inherits(MultiGrid, React__namespace.PureComponent);
        ...
        function MultiGrid(props, context) {
            ...
            _defineProperty(_assertThisInitialized(_this), "_bottomLeftGridRef", function(ref) {
                ...
                var rowIndex = _ref.rowIndex, rest = _objectWithoutProperties(_ref, _excluded), _this$props = _this.props, cellRenderer = _this$props.cellRenderer, fixedRowCount = _this$props.fixedRowCount;
                return rowIndex === _this$props.rowCount - fixedRowCount ? React__namespace.createElement("div", {
                    key: rest.key,
                ...
                return columnIndex === columnCount - fixedColumnCount ? React__namespace.createElement("div", {
                    key: rest.key,
                    style: _objectSpread2(_objectSpread2({}, rest.style), {}, {
                        width: 20
                    })
        ...
        return _createClass(MultiGrid, [ {
            ...
            key: "render",
            value: function() {
                var _this$props8 = this.props, onScroll = _this$props8.onScroll, onSectionRendered = _this$props8.onSectionRendered;
                _this$props8.onScrollbarPresenceChange, _this$props8.scrollLeft;
            ...
            value: function(props) {
                ...
                return hideBottomLeftGridScrollbar ? React__namespace.createElement("div", {
            ...
            value: function(props) {
                ...
                return React__namespace.createElement(Grid, _extends({}, props, {
            ...
            value: function(props) {
                ...
                return fixedColumnCount && fixedRowCount ? React__namespace.createElement(Grid, _extends({}, props, {
            ...
            value: function(props) {
                ...
                var topRightGrid = React__namespace.createElement(Grid, _extends({}, props, {
                ...
                return hideTopRightGridScrollbar ? React__namespace.createElement("div", {
    ...
    var ScrollSync = function() {
        _inherits(ScrollSync, React__namespace.PureComponent);
    ...
    function SortIndicator(_ref) {
        ...
        return React__namespace.createElement("svg", {
            ...
            height: 18,
            viewBox: "0 0 24 24"
        }, sortDirection === SortDirection.ASC ? React__namespace.createElement("path", {
            d: "M7 14l5-5 5 5z"
    ...
    function defaultHeaderRenderer(_ref) {
        var dataKey = _ref.dataKey, label = _ref.label, sortBy = _ref.sortBy, sortDirection = _ref.sortDirection, showSortIndicator = sortBy === dataKey, children = [ React__namespace.createElement("span", {
            className: "ReactVirtualized__Table__headerTruncatedText",
            key: "label",
            title: "string" == typeof label ? label : null
        }, label) ];
        return showSortIndicator && children.push(React__namespace.createElement(SortIndicator, {
            key: "SortIndicator",
    ...
    function defaultRowRenderer(_ref) {
        ...
        })), React__namespace.createElement("div", _extends({}, a11yProps, {
            className: className,
            key: key,
            role: "row",
            style: style
    ...
    var Column = function() {
        _inherits(Column, React__namespace.Component);
    ...
    var Table = function() {
        _inherits(Table, React__namespace.PureComponent);
        ...
        return _createClass(Table, [ {
            ...
            value: function() {
                if (this.Grid) {
                    var _Grid = this.Grid._scrollingContainer, clientWidth = _Grid.clientWidth || 0;
            ...
            value: function() {
                ...
                return this._cachedColumnStyles = [], React__namespace.Children.toArray(children).forEach(function(column, index) {
                    ...
                    "aria-colcount": React__namespace.Children.toArray(children).length,
                ...
                }), React__namespace.createElement(Grid, _extends({}, this.props, {
                    "aria-readonly": null,
                    autoContainerWidth: !0,
            ...
            value: function(_ref6) {
                var _this3 = this, index = _ref6.rowIndex, isScrolling = _ref6.isScrolling, key = _ref6.key, parent = _ref6.parent, style = _ref6.style, _this$props3 = this.props, children = _this$props3.children, onRowClick = _this$props3.onRowClick, onRowDoubleClick = _this$props3.onRowDoubleClick, onRowRightClick = _this$props3.onRowRightClick, onRowMouseOver = _this$props3.onRowMouseOver, onRowMouseOut = _this$props3.onRowMouseOut, rowClassName = _this$props3.rowClassName, rowGetter = _this$props3.rowGetter, rowRenderer = _this$props3.rowRenderer, rowStyle = _this$props3.rowStyle, scrollbarWidth = this.state.scrollbarWidth, rowClass = "function" == typeof rowClassName ? rowClassName({
                    ...
                    index: index
                }), columns = React__namespace.Children.toArray(children).map(function(column, columnIndex) {
            ...
            value: function(column, argument_1) {
                var customStyle = 1 < arguments.length && void 0 !== argument_1 ? argument_1 : {}, flexValue = "".concat(column.props.flexGrow, " ").concat(column.props.flexShrink, " ").concat(column.props.width, "px"), style = _objectSpread2(_objectSpread2({}, customStyle), {}, {
                    flex: flexValue,
                    msFlex: flexValue,
            ...
            value: function() {
                ...
                return (_this$props4.disableHeader ? [] : React__namespace.Children.toArray(children)).map(function(column, index) {
    ...
    _defineProperty(Table, "propTypes", {
        ...
        children: function(props) {
            for (var children = React__namespace.Children.toArray(props.children), i = 0; i < children.length; i++) {
    ...
    var getWindow = function() {
        ...
        _inherits(WindowScroller, React__namespace.PureComponent);
        ...
        return _createClass(WindowScroller, [ {
            key: "updatePosition",
            value: function(argument_0) {
                var scrollElement = 0 < arguments.length && void 0 !== argument_0 ? argument_0 : this.props.scrollElement, onResize = this.props.onResize, _this$state = this.state, height = _this$state.height, width = _this$state.width, thisNode = this._child || ReactDOM__namespace.findDOMNode(this);
    ...
    exports.accessibilityOverscanIndicesGetter = defaultOverscanIndicesGetter, exports.createMasonryCellPositioner = function(_ref) {
    ...
    }, exports.defaultCellRangeRenderer = defaultCellRangeRenderer, exports.defaultOverscanIndicesGetter = defaultOverscanIndicesGetter$1, 
